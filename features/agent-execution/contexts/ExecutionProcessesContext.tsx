...
import { useExecutionProcesses } from '@/features/agent-execution/hooks/useExecutionProcesses'
import type { ExecutionProcess } from '@/features/agent-execution/types/execution-process'

type ExecutionProcessesContextType = {
  // All processes (including dropped)
  ...
  // Visible processes (excluding dropped)
...
const ExecutionProcessesContext = createContext<ExecutionProcessesContextType | null>(
  null
)

// EntriesContext.tsx - Entries state management
// Adapted from vibe-kanban

'use client'

import { createContext, useContext, useState, useMemo, useCallback, ReactNode } from 'react'
import type { PatchTypeWithKey, TokenUsageInfo } from '@/features/agent-execution/types'
...
export const useOptionalEntriesContext = (): EntriesContextType | null => {

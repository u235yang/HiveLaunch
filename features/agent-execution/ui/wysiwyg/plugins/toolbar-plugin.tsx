...
function ToolbarButton({
  ...
  return (
    <button
      ...
      aria-label={title}
      className={cn(
        'p-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors bg-gray-50 dark:bg-gray-800',
...
export function ToolbarPlugin() {
  ...
  return createPortal(
    <div
      ...
      className="fixed z-[10000] flex items-center gap-0.5 px-1.5 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg animate-in fade-in-0 duration-100"
      style={{
        top: position.top,
        left: position.left,
      }}

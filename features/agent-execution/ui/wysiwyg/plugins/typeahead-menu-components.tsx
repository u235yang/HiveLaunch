  ...
  return (
    <Popover open>
      ...
      <PopoverContent
        ...
        style={contentStyle}
        className="w-auto min-w-80 max-w-[370px] p-0 overflow-hidden !bg-white dark:!bg-gray-800"
      >
        {children}
      </PopoverContent>
    </Popover>
...
function TypeaheadMenuEmpty({ children }: { children: ReactNode }) {
  return (
    <div className="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">{children}</div>
  )
}
...
function TypeaheadMenuAction({
  ...
  return (
    <button
      type="button"
      className="w-full px-3 py-2 text-left text-sm border-l-2 border-l-transparent text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
  ...
  return (
    <div
      ...
      className={`px-3 py-2 cursor-pointer text-sm border-l-2 ${
        isSelected
          ? 'bg-gray-100 dark:bg-gray-700 border-l-amber-500 text-gray-900 dark:text-white'
          : 'hover:bg-gray-50 dark:hover:bg-gray-800 border-l-transparent text-gray-600 dark:text-gray-300'
      }`}

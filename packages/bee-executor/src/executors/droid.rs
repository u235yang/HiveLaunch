...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, TS, JsonSchema, Default)]
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, TS, JsonSchema, AsRefStr, Default)]

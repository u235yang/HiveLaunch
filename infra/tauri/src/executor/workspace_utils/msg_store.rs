...
use crate::workspace_utils::log_msg::LogMsg;
...
impl MsgStore {
    ...
    pub fn push_patch(&self, patch: json_patch::Patch) {
        log::info!("[MsgStore] push_patch: {} operations", patch.0.len());
    ...
    pub fn stdout_lines_stream(
        ...
        self.stdout_chunked_stream()
            .flat_map(|res| match res {
                Ok(chunk) => {
                    let lines: Vec<std::io::Result<String>> = chunk
                        .lines()
